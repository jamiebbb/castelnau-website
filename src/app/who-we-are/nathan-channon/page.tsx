        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center gap-8">
            <div className="relative w-48 h-48 rounded-full overflow-hidden shadow-xl">
              <Image
                src="/team_images/nathan_channon.jpg"
                alt="Nathan Channon"
                fill
            ...
            <div className="text-center md:text-left text-white">
              ...
              <h1 className="text-4xl md:text-5xl font-serif font-bold mb-4">Nathan Channon</h1>
              <p className="text-xl md:text-2xl text-white/90">Chief Technology Officer</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none">
              <p className="text-xl text-gray-700 leading-relaxed mb-8">
                Nathan leads the technology vision and digital transformation initiatives across Castelnau Group, driving innovation in financial technology solutions.
              </p>
            </div>
...
export default NathanChannonPage; 